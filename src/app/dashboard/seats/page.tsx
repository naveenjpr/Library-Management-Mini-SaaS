        ...
        <div className="p-6">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {filteredSeats.map((seat) => (
              <div
                key={seat.id}
                className={`group relative p-4 rounded-base border cursor-pointer transition-all duration-300 ${seat.is_active
              ...
              >
                <div className="flex flex-col items-center justify-center space-y-2 cursor-pointer">
                  ...
                  <span className={`text-[10px] cursor-pointer uppercase tracking-wider font-bold px-2 py-0.5 rounded-full ${seat.is_active ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" : "bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-500"
                    }`}>
                    {seat.is_active ? "Active" : "Inactive"}
                  </span>
                </div>

                <div className="absolute top-2 right-2 opacity-0 cursor-pointer group-hover:opacity-100 transition-opacity">
                  <button
