      ...
      `}>
        ...
        <div className="mt-auto p-4 border-t border-default-medium dark:border-gray-800">
          ...
          <button
            ...
            className="cursor-pointer flex items-center w-full px-4 py-2.5 text-sm font-medium text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-900/10 rounded-base transition-colors"
          >
